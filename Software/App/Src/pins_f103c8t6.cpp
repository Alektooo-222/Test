...
Pin ListPins[37] = {
    {{"PA0", GPIOA, GPIO_PIN_0}, {/* {TIM2, TIM_CHANNEL_1, Inverse_Ch::P} */}, Pin_configured::NO_CONFIG},
    {{"PA1", GPIOA, GPIO_PIN_1}, {/* {TIM2, TIM_CHANNEL_2, Inverse_Ch::P} */}, Pin_configured::NO_CONFIG},
    {{"PA2", GPIOA, GPIO_PIN_2}, {/* {TIM2, TIM_CHANNEL_3, Inverse_Ch::P} */}, Pin_configured::NO_CONFIG},
    {{"PA3", GPIOA, GPIO_PIN_3}, {/* {TIM2, TIM_CHANNEL_4, Inverse_Ch::P} */}, Pin_configured::NO_CONFIG},
    {{"PA4", GPIOA, GPIO_PIN_4}, {}, Pin_configured::NO_CONFIG},
    {{"PA5", GPIOA, GPIO_PIN_5}, {}, Pin_configured::NO_CONFIG},
    {{"PA6", GPIOA, GPIO_PIN_6}, {/* {TIM3, TIM_CHANNEL_1, Inverse_Ch::P},  */}, Pin_configured::NO_CONFIG},
    {{"PA7", GPIOA, GPIO_PIN_7}, {/* {TIM3, TIM_CHANNEL_2, Inverse_Ch::P},  */}, Pin_configured::NO_CONFIG}, // TIM1_CH1N, TIM8_CH1N
    ...
    {{"PB0", GPIOB, GPIO_PIN_0}, {/* {TIM3, TIM_CHANNEL_3, Inverse_Ch::P} */}, Pin_configured::NO_CONFIG},
    {{"PB1", GPIOB, GPIO_PIN_1}, {/* {TIM3, TIM_CHANNEL_4, Inverse_Ch::P} */}, Pin_configured::NO_CONFIG},
    ...
    {{"PB8", GPIOB, GPIO_PIN_8}, {{TIM4, TIM_CHANNEL_3, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    {{"PB9", GPIOB, GPIO_PIN_9}, {{TIM4, TIM_CHANNEL_4, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    ...
    {{"PB14", GPIOB, GPIO_PIN_14}, {/* {TIM1, TIM_CHANNEL_2, Inverse_Ch::N} */}, Pin_configured::NO_CONFIG},
    {{"PB15", GPIOB, GPIO_PIN_15}, {/* {TIM1, TIM_CHANNEL_3, Inverse_Ch::N} */}, Pin_configured::NO_CONFIG},
