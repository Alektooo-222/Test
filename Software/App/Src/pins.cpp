...
Pin ListPins[NUMBER_OF_AVAILABLE] = {
    ...
    {{"PA6", GPIOA, GPIO_PIN_6}, {}, Pin_configured::NO_CONFIG},
    {{"PA7", GPIOA, GPIO_PIN_7}, {{TIM8, TIM_CHANNEL_1, Inverse_Ch::N}}, Pin_configured::NO_CONFIG},
    ...
    {{"PA15", GPIOA, GPIO_PIN_15}, {}, Pin_configured::NO_CONFIG},

    {{"PB0", GPIOB, GPIO_PIN_0}, {{TIM8, TIM_CHANNEL_2, Inverse_Ch::N}}, Pin_configured::NO_CONFIG},
    {{"PB1", GPIOB, GPIO_PIN_1}, {{TIM8, TIM_CHANNEL_3, Inverse_Ch::N}}, Pin_configured::NO_CONFIG},
    {{"PB2", GPIOB, GPIO_PIN_2}, {}, Pin_configured::NO_CONFIG},
    {{"PB3", GPIOB, GPIO_PIN_3}, {}, Pin_configured::NO_CONFIG},
    {{"PB4", GPIOB, GPIO_PIN_4}, {}, Pin_configured::NO_CONFIG},
    {{"PB5", GPIOB, GPIO_PIN_5}, {}, Pin_configured::NO_CONFIG},
    ...
    {{"PB10", GPIOB, GPIO_PIN_10}, {}, Pin_configured::NO_CONFIG},
    {{"PB11", GPIOB, GPIO_PIN_11}, {}, Pin_configured::NO_CONFIG},
    {{"PB12", GPIOB, GPIO_PIN_12}, {}, Pin_configured::NO_CONFIG},
    {{"PB13", GPIOB, GPIO_PIN_13}, {{TIM1, TIM_CHANNEL_1, Inverse_Ch::N}}, Pin_configured::NO_CONFIG},                                      
    ...
    {{"PC6", GPIOC, GPIO_PIN_6}, {{TIM8, TIM_CHANNEL_1, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    {{"PC7", GPIOC, GPIO_PIN_7}, {{TIM8, TIM_CHANNEL_2, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    {{"PC8", GPIOC, GPIO_PIN_8}, {{TIM8, TIM_CHANNEL_3, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    {{"PC9", GPIOC, GPIO_PIN_9}, {{TIM8, TIM_CHANNEL_4, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
