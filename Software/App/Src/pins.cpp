...
Pin ListPins[50] = {
    ...
    {{"PA2", GPIOA, GPIO_PIN_2}, {{TIM9, TIM_CHANNEL_1, Inverse_Ch::P}, {TIM2, TIM_CHANNEL_3, Inverse_Ch::P}, {TIM5, TIM_CHANNEL_3, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    {{"PA3", GPIOA, GPIO_PIN_3}, {{TIM9, TIM_CHANNEL_2, Inverse_Ch::P}, {TIM2, TIM_CHANNEL_4, Inverse_Ch::P}, {TIM5, TIM_CHANNEL_4, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    ...
    {{"PA6", GPIOA, GPIO_PIN_6}, {/* {TIM3, TIM_CHANNEL_1, Inverse_Ch::P},  */{TIM13, TIM_CHANNEL_1, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    {{"PA7", GPIOA, GPIO_PIN_7}, {{TIM1, TIM_CHANNEL_1, Inverse_Ch::N}, {TIM8, TIM_CHANNEL_1, Inverse_Ch::N}, /* {TIM3, TIM_CHANNEL_2, Inverse_Ch::P},  */{TIM14, TIM_CHANNEL_1}}, Pin_configured::NO_CONFIG}, // TIM1_CH1N, TIM8_CH1N
    ...
    {{"PB8", GPIOB, GPIO_PIN_8}, {{TIM10, TIM_CHANNEL_1, Inverse_Ch::P}, {TIM2, TIM_CHANNEL_1, Inverse_Ch::P}, {TIM4, TIM_CHANNEL_3, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    {{"PB9", GPIOB, GPIO_PIN_9}, {{TIM11, TIM_CHANNEL_1, Inverse_Ch::P}, {TIM2, TIM_CHANNEL_2, Inverse_Ch::P}, {TIM4, TIM_CHANNEL_4, Inverse_Ch::P}}, Pin_configured::NO_CONFIG},
    ...
    {{"PB14", GPIOB, GPIO_PIN_14}, {{TIM1, TIM_CHANNEL_2, Inverse_Ch::N}, {TIM8, TIM_CHANNEL_2, Inverse_Ch::N}, {TIM12, TIM_CHANNEL_1, Inverse_Ch::P}}, Pin_configured::NO_CONFIG}, // TIM1_CH2N TIM8_CH2N
    {{"PB15", GPIOB, GPIO_PIN_15}, {{TIM1, TIM_CHANNEL_3, Inverse_Ch::N}, {TIM8, TIM_CHANNEL_3, Inverse_Ch::N}, {TIM12, TIM_CHANNEL_2, Inverse_Ch::P}}, Pin_configured::NO_CONFIG}, // TIM1_CH3N TIM8_CH3N
    ...
    {{"PD2", GPIOD, GPIO_PIN_2}, {}, Pin_configured::NO_CONFIG},

    {{"PH0", GPIOH, GPIO_PIN_0}, {}, Pin_configured::OSC_IN},
    {{"PH1", GPIOH, GPIO_PIN_1}, {}, Pin_configured::OSC_OUT}
};